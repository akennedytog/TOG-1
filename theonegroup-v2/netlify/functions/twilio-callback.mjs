// Twilio callbacks for The One Group (754) 799-8676
...
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL || 'The One Group calls <hello@theonegroup.info>';
