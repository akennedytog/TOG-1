...
SIMPLE_NAV_PATTERN = r'  <nav class="fixed top-0 left-0 right-0 z-50 glass border-b border-gray-200 dark:border-gray-800">\s*<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">\s*<div class="flex justify-between items-center h-16">\s*<a href="/" class="font-bold text-xl"><span class="gradient-text">The One Group</span></a>\s*<div class="hidden md:flex items-center space-x-8">\s*<a href="/about\.html"[^>]*>About</a>\s*<a href="/services\.html"[^>]*>Services</a>\s*<a href="/case-studies\.html"[^>]*>Case Studies</a>\s*<a href="/blog\.html"[^>]*>Blog</a>\s*</div>\s*<a href="/free-ai-audit\.html"[^>]*>Free Audit</a>\s*</div>\s*</div>\s*</nav>'

files = [
    '/Users/aleckennedy/.openclaw/workspace/theonegroup-site/ai-optimization.html',
...
for filepath in files:
    try:
        ...
        # Replace simple nav with full nav
        new_content = re.sub(SIMPLE_NAV_PATTERN, FULL_NAV, content, flags=re.DOTALL)
